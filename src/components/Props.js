                    ...
                    <div className="rotatingImage">
                        <div className="rotate">
                            ...
                            <div className="frontSide">
                                <img className="img" src={props.im2g} src="MsMahiya.jfif"  alt="front" />
                            </div>

                            <div className="leftSide">
                                <img className="img" src={props.im2g} src="MsMahiya.jfif"  alt="left" />
                            </div>

                            <div className="rightSide">
                                <img className="img" src={props.im3g} src="MsMahiya.jfif"  alt="right" />
                            </div>

                            <div className="backSide"> 
                                <img className="img" src={props.im4g} src="MsMahiya.jfif" alt="back" />
                            </div>

                            <div className="topSide"> 
                                <img className="img" src={props.im4g} src="MsMahiya.jfif" alt="top" />
                            </div>

                            <div className="bottomSide"> 
                                <img className="img" src={props.im4g} src="MsMahiya.jfif" alt="bottom" />
                            </div>
